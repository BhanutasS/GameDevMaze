...
class HomeState(BaseState):
    def __init__(self, state_machine):
        super(HomeState, self).__init__(state_machine)
    ...
    def render(self, screen):
        ...
        t_title = gFonts['gothic_large'].render("Maze Escape", False, (34, 34, 34))
        rect = t_title.get_rect(center=(WIDTH / 2 + 6, HEIGHT / 2 - 90))
        screen.blit(t_title, rect)
        t_title = gFonts['gothic_large'].render("Maze Escape", False, (175, 53, 42))
