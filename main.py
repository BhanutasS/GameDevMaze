...
class GameMain:
    def __init__(self):
        ...
        states = {
            'start': HomeState(self.g_state_manager),
            'play': MapState(self.g_state_manager),
            'game_over': LoserState(self.g_state_manager),
        }
    ...
    def PlayGame(self):
        ...
        while True:
            pygame.display.set_caption("Maze Escape game running with {:d} FPS".format(int(clock.get_fps())))
